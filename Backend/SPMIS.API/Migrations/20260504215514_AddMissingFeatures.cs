        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluationComments = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupervisorFeedback = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@spmis.edu", "Admin Default", "admin", "Admin" },
                    { 2, "supervisor@spmis.edu", "Dr. Supervisor", "password", "Supervisor" },
                    { 3, "student@spmis.edu", "Student Default", "password", "Student" }
                });
        }
